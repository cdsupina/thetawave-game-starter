...
use thetawave_assets::{AssetResolver, MergedBackgroundAssets};
...
pub(super) fn spawn_bg_system(
    ...
    let planet_scene = AssetResolver::get_random_planet(&bg_assets)?;
