...
use crate::{
    data::EditorSession,
    file::{FileTreeState, LoadMobEvent, NewMobEvent, SaveMobEvent},
    states::EditorState,
};

use super::{file_panel_ui, properties_panel_ui, toolbar_ui};
...
pub fn main_ui_system(
    ...
    // Top toolbar
    toolbar_ui(ctx, &mut session, &mut save_events);
