        ...
        Self {
            behaviors: HashMap::from([
                ...
                (
                    ...
                    behave! {
                        Behave::Forever => {
                            Behave::spawn_named("Movement", MobBehaviorComponent { behaviors: vec![MobBehaviorType::MoveDown, MobBehaviorType::BrakeHorizontal, MobBehaviorType::SpawnProjectile(Some(vec!["south".to_string(), "east".to_string()]))]  }),
                        }
                    },
                ),
                (
